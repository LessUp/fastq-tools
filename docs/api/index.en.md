...
- [Overview](overview.en.md) - API design principles and conventions
- [IO Module](io.en.md) - FASTQ file read/write interfaces
- [Processing Pipeline](processing.en.md) - Data processing pipe interfaces
- [Statistics](statistics.en.md) - Statistical computation interfaces
- [Core Utilities](core.en.md) - General utilities and helpers
