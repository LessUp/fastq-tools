...
Use the lightweight change workflow for high-risk changes (build, release,
compatibility). Small low-risk fixes may follow the repository's existing process.
