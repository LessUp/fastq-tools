# =============================================================================
# FastQTools DevContainer - Windows 宿主机环境准备脚本
# =============================================================================
...
function Main {
    ...
    Write-Host " FastQTools Windows 环境准备" -ForegroundColor Cyan
    Write-Host "========================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    if (Test-WSL -and (Test-WSLDistro)) {
        ...
        try {
            ...
            Write-Info "建议将项目克隆到 WSL 内: $wslHome/projects/fastq-tools"
        } catch {}
        Write-Host ""
    }
    ...
    if ($needsReboot) {
        ...
        Write-Host "      git clone <repo> ~/projects/fastq-tools" -ForegroundColor Gray
        Write-Host "   2. 准备环境配置" -ForegroundColor White
        Write-Host "      cd ~/projects/fastq-tools" -ForegroundColor Gray
